...
class HealthCheckResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sfcas.healthcheck.HealthCheckResponse) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "sfcas.healthcheck.HealthCheckResponse";
  }
  protected:
  ...
  void clear_status() ;
  ::sfcas::healthcheck::HealthCheckResponse_ServingStatus status() const;
  void set_status(::sfcas::healthcheck::HealthCheckResponse_ServingStatus value);

  private:
  ::sfcas::healthcheck::HealthCheckResponse_ServingStatus _internal_status() const;
  void _internal_set_status(::sfcas::healthcheck::HealthCheckResponse_ServingStatus value);

  public:
  // @@protoc_insertion_point(class_scope:sfcas.healthcheck.HealthCheckResponse)
 private:
  class _Internal;
...
class HealthCheckRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sfcas.healthcheck.HealthCheckRequest) */ {
 public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "sfcas.healthcheck.HealthCheckRequest";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:sfcas.healthcheck.HealthCheckRequest)
 private:
  class _Internal;
...
inline const std::string& HealthCheckRequest::service() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:sfcas.healthcheck.HealthCheckRequest.service)
...
inline PROTOBUF_ALWAYS_INLINE void HealthCheckRequest::set_service(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:sfcas.healthcheck.HealthCheckRequest.service)
}
inline std::string* HealthCheckRequest::mutable_service() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ...
  // @@protoc_insertion_point(field_mutable:sfcas.healthcheck.HealthCheckRequest.service)
  return _s;
}
...
inline std::string* HealthCheckRequest::release_service() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:sfcas.healthcheck.HealthCheckRequest.service)
...
inline void HealthCheckRequest::set_allocated_service(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:sfcas.healthcheck.HealthCheckRequest.service)
}
...
inline ::sfcas::healthcheck::HealthCheckResponse_ServingStatus HealthCheckResponse::status() const {
  // @@protoc_insertion_point(field_get:sfcas.healthcheck.HealthCheckResponse.status)
  return _internal_status();
}
inline void HealthCheckResponse::set_status(::sfcas::healthcheck::HealthCheckResponse_ServingStatus value) {
  _internal_set_status(value);
  // @@protoc_insertion_point(field_set:sfcas.healthcheck.HealthCheckResponse.status)
}
inline ::sfcas::healthcheck::HealthCheckResponse_ServingStatus HealthCheckResponse::_internal_status() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return static_cast<::sfcas::healthcheck::HealthCheckResponse_ServingStatus>(_impl_.status_);
}
inline void HealthCheckResponse::_internal_set_status(::sfcas::healthcheck::HealthCheckResponse_ServingStatus value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
...
template <>
struct is_proto_enum<::sfcas::healthcheck::HealthCheckResponse_ServingStatus> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::sfcas::healthcheck::HealthCheckResponse_ServingStatus>() {
  return ::sfcas::healthcheck::HealthCheckResponse_ServingStatus_descriptor();
}
